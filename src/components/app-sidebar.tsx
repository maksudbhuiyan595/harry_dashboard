    ...
    >
      ...
      <SidebarFooter className=" bg-[#3A3E41] p-4">
        ...
        <div className="flex items-center gap-2 w-full">
          ...
          <Button onClick={handleLogout} variant="destructive" className="w-full flex items-center justify-center gap-[50%] ">Log Out <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
